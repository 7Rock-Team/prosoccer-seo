...
| B-PACK-02 | 48-char meta title cap vs the pack-qualifier rule (fold-over tongue configs) | High | Step 2 Batch 13 second correction pass 2026-08-13 (Case B, ORIN halted the edit) | IH4707 and JP6248 meta titles identify the page by config alone (`adidas Predator Elite Fold-Over Tongue AG` / `FG`, 41 each). Both configs have many live packs (AG: Road to Glory SP26 + 4 more; FG: Road to Glory SP26 + 8 more), and JP6248's title is registered incumbent JP6237's primary verbatim. Config + pack is 58 chars, "FO Tongue" + pack is 51, so nothing fits under 48. Cap and pack succession are in direct conflict. Options with counts are in the pass report and `_audit-trail.md` 'Second correction pass'. Mike decides: abbreviate, pack pipe suffix, drop the brand prefix, or raise the cap for this class. Both pages HELD, unedited, pre-import. |
