# Input: KC3993 -- adidas Real Madrid Youth Stadium Home 2026-27
...
## Identity
- SKU: KC3993
- URL: https://www.prosoccer.com/products/adidas-2026-27-real-madrid-youth-stadium-home-soccer-jersey
- Handle: adidas-2026-27-real-madrid-youth-stadium-home-soccer-jersey  (NEVER change the handle; flag-only)
- Brand: adidas
...
|---|---|---|---|
| Primary | real madrid youth jersey | 590 |  |
| Secondary | real madrid kids jersey |  |  |
| Secondary | real madrid youth home jersey |  |  |
...
- Angle of emphasis: the young fan's first Madrid shirt / growing up in white
...
- Use-case scenario: parent buying the youth stadium shirt for a young Madridista
- Heritage / positioning angle: Real Madrid club identity through a young-fan lens, qualitative only
- Facet vs siblings: the YOUTH stadium (short-sleeve) cut; head of the youth axis
...
RM claims: QUALITATIVE ONLY. No European Cup count, no superlative. La Liga nameable. European competition GENERIC, never 'Champions League'. Youth sizing/growth + name-number customization if scrape-confirmed. Sourced-or-qualified only.
...
```gate-meta
{
  ...
  "primary_keyword": "real madrid youth jersey",
  "forbidden_phrasings": {
    "verbatim": [],
    "motifs": [],
    "title_frames": []
