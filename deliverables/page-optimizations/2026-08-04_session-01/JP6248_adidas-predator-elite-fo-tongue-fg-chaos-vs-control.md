# adidas Predator Elite Fold-Over Tongue FG Chaos vs Control -- PDP Optimization

## Quick Reference
- SKU: JP6248
- Current live Title (for Shopify admin search): adidas Predator Elite Fo Tongue FG Soccer Cleats Chaos Vs Control
- URL: https://www.prosoccer.com/products/adidas-predator-elite-fo-tongue-fg-soccer-cleats-chaos-vs-control
...
|---|---|---|---|
| Primary | adidas predator elite fold-over tongue fg chaos vs control | no measurable (pack sub-floor by design) |  |
...
### Short Description
The ball drops in the box and you've got half a yard. That's all a finisher needs, and the adidas Predator Elite Fold-Over Tongue FG in the Chaos vs Control pack is built for that half yard. The tongue folds over the laces, so the top of the cleat is one smooth surface with nothing to catch the ball wrong. You strike clean over the instep, and the shot goes where you aimed. See the chance early, take it, put it away.

### Description

## A clean top for the box finisher

You know the type. The striker who needs one touch, not three. The adidas Predator Elite Fold-Over Tongue FG is cut for that player. It sits in the [adidas Predator soccer cleats](https://www.prosoccer.com/collections/adidas-predator) line, and Predator has always been about damage on the ball. Here that damage comes off a covered instep.
...
The Predator Elite runs true to size for most players. Between sizes, or want a locked-in feel for quick turns? Go down a half. The regular fit suits a normal-to-slightly-narrow foot; wide-footed players should try them on first.
...
## FAQs about the Predator Elite Fold-Over Tongue

### What does the fold-over tongue actually do?

It folds the collar over your laces, so the top of the cleat is one smooth surface. Nothing catches the ball when you strike over the instep.

### Does the Fold-Over Tongue run true to size?

Yes, true to size for most players. Want a tighter feel? Drop a half size.
...
### URL Handle
adidas-predator-elite-fo-tongue-fg-soccer-cleats-chaos-vs-control (unchanged)
