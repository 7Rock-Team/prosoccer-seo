...
- **Cruz Azul:** `cruz azul jersey`, `cruz azul soccer jersey` to `/collections/cruz-azul` (added 2026-08-26, Batch 16; live-verified H1 "Cruz Azul Club Collection", 6 products, page title "Cruz Azul Club Collection | Pro Soccer". SECOND Liga MX lane. `cruz azul jersey` is the largest head term ceded to date at 12,100/mo, confirmed on both DFS endpoints, and it is strongly seasonal: 33,100 in 2026-07 against 4,400 in 2026-01, so a kit-launch window drives it. The collection row was created by this batch and carried no primary of its own; the cede terms were the first entry on its `ceded_from`.)
