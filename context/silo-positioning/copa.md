...
- **Upper material is tier-split. Do NOT call the line "kangaroo" or "K-leather."** Elite and Pro use **Fusionskin** (a calfskin-leather forefoot stitched to a synthetic mesh midfoot); "calfskin leather touch" is accurate for Elite/Pro. **League uses Fusionfeel, a fully synthetic upper: do NOT call the League tier "leather" at all.** The K-leather heritage belongs to Copa Mundial / Copa Gloro, NOT Copa Pure.
- **Plate is "Comfort Frame" across the line. "Sprintframe" is FORBIDDEN (unverified for this silo).**
