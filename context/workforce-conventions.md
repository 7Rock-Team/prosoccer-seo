...
- The pack qualifier carries the season code when a pack name recurs across seasons ("shadow fa26" versus "shadow fa25"), so two packs never collide on the same qualified term. Confirmed necessary on the live store 2026-08-04 (a Shadow FA25 and a Shadow FA26 of the same shoe both live).
